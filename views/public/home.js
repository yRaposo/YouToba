          ...
          <ScrollView horizontal>
            <View style={styles.headerInfContainer}>
              <BadgeBtn
                ...
                onPress={() => console.log("barraLateral")}
              />
              <BadgeBtn
                name="Tudo"
                isActive={activeBadge}
              ...
              <BadgeBtn
                ...
                isActive={activeBadge}
                text
                onPress={() => setActiveBadge("Valorant")}
              />
              <BadgeBtn
                name="CS:GO"
                isActive={activeBadge}
                text
                onPress={() => setActiveBadge("CS:GO")}
              />
              <BadgeBtn
                name="LoL"
                isActive={activeBadge}
                text
                onPress={() => setActiveBadge("LoL")}
              />
              <BadgeBtn
                name="Overwatch"
                isActive={activeBadge}
                text
                onPress={() => setActiveBadge("Overwatch")}
              />
              <BadgeBtn
                name="R6"
                isActive={activeBadge}
                text
                onPress={() => setActiveBadge("R6")}
              />
              <BadgeBtn
                name="Fortnite"
                isActive={activeBadge}
                text
                onPress={() => setActiveBadge("Fortnite")}
              />
              <BadgeBtn
                name="Minecraft"
                isActive={activeBadge}
                text
                onPress={() => setActiveBadge("Minecraft")}
              />
              <BadgeBtn
                name="Among Us"
                isActive={activeBadge}
                text
                onPress={() => setActiveBadge("Among Us")}
              />
              <BadgeBtn
                name="Gartic"
                isActive={activeBadge}
                text
                onPress={() => setActiveBadge("Gartic")}
              />
              <BadgeBtn
                name="Free Fire"
                isActive={activeBadge}
                text
                onPress={() => setActiveBadge("Free Fire")}
              />
              <BadgeBtn
                name="PUBG"
                isActive={activeBadge}
                text
                onPress={() => setActiveBadge("PUBG")}
              />
              <BadgeBtn
                name="Mobile Legends"
                isActive={activeBadge}
                text
                onPress={() => setActiveBadge("Mobile Legends")}
              />
            </View>
          </ScrollView>
        </View>
